...
# # response cache----------------------------------------------------------------------------------------------------------
#
# def cache_check(endpoint, response, params):
#
...
#             logging.warning(f'saved cached response for {endpoint}')
...
#
#     cache_path = cache_path / f'{endpoint}-{params_path}.pickle'
#
#     try:
#         with open(cache_path, 'rb') as f:
#             logging.warning(f'loaded cached response for endpoint: {endpoint}')
